...
namespace Task3
{
    public abstract class Terminal : ITerminal
    {
        ...
        protected virtual void OnOutgoingCall(object sender, PhoneNumber target)
        {
            ...
            {
                ServerIncomingRequest = new OutgoingCallRequest() { Source = this.Number, Target = target };
        ...
        public void Drop()
        {
            ...
            {
                OnIncomingRespond(this, new Respond() { Source = Number, State = RespondState.Drop, Request = ServerIncomingRequest });
                if (IsOnline)
                {
                    OnOffline(this, null);
                }
